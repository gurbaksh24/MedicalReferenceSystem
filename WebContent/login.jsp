...
<section>
	<br>
<div class="container">
	<h1>How you want to login?</h1>
	<a href="login_doctor.jsp" class="btn btn-success">Login as DOCTOR</a>
	<a href="login_patient.jsp" class="btn btn-success">Login as USER</a>
</div>
<div class="container">
	<a href="login_admin.jsp" class="btn btn-danger">Login as ADMINISTRATOR</a>
</div>
<br>
</section>
